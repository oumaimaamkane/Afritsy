                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 ">
                    <div className="">
                        <div className="flex flex-col-reverse items-center justify-between gap-8">
                            <img className="block h-30 w-auto mx-auto m-3 -mt-16 sm:-mt-0" style={{ marginBottom: "-95px" }} src={Logo} alt="Afritsy Logo" />
                        </div>

                        <div className="flex flex-col-reverse sm:flex-row items-center justify-center gap-5 pt-7 mb-8 sm:mb-0 mp-3">
                            ...
                            <div className="w-full max-lg:mx-auto flex flex-col sm:flex-row max-lg:items-center max-lg:justify-between gap-6 md:gap-12 lg:gap-24" style={{ paddingLeft: '90px' }}>
                                    ...
                                    <ul className="flex flex-col max-lg:items-center gap-6">
                                        <li className="text-base font-normal max-lg:text-center text-black flex items-center whitespace-nowrap transition-all duration-300 focus-within:outline-0 focus-within:text-amber-400">
                                            <a href="https://www.google.com/maps/place/30.380281721333553,-9.504695750319959" target="_blank" rel="noopener noreferrer" className="flex items-center">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 384 512">
                                                    <path fill="#000000" d="M215.7 499.2C267 435 384 279.4 384 192C384 86 298 0 192 0S0 86 0 192c0 87.4 117 243 168.3 307.2c12.3 15.3 35.1 15.3 47.4 0zM192 128a64 64 0 1 1 0 128 64 64 0 1 1 0-128z" />
                                                </svg>
                                                <span className="ml-2">1422 1st St. Santa Rosa, CA 94559.</span>
                                            </a>
                                        </li>
                                        ...
                                        <li className="text-base font-normal max-lg:text-center text-black flex items-center whitespace-nowrap transition-all duration-300 focus-within:outline-0 focus-within:text-amber-400 align-items-center">
                                            <a href="mailto:admin@e-mail.com" className="flex items-center">
                                                ...
                                                <span className="ml-2">admin@e-mail.com</span>
                                            </a>
                                        </li>

                                        <li className="text-base font-normal max-lg:text-center text-black flex items-center whitespace-nowrap transition-all duration-300 focus-within:outline-0 focus-within:text-amber-400">
                                            <a href="tel:00201008431112" className="flex items-center">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 512 512">
                                                ...
                                                <span className="ml-2">002-01008431112</span>
                                            </a>
                                        </li>
                                ...
                                <div className="">
                                    ...
                                    <ul className="flex flex-col gap-6 max-lg:items-center">
                                        ...
                                        <li><a href="#" className="text-base font-normal text-black whitespace-nowrap transition-all duration-300 hover:text-amber-400 focus-within:outline-0 focus-within:text-amber-400">User Guide</a></li>
                                    </ul>
                                </div>
                            </div>

                            <div className="w-full lg:max-w-md max-lg:mx-auto">
                                <h6 className="text-lg font-medium text-black mb-7">Social Links</h6>
                    ...
                    <div className="flex flex-col-reverse sm:flex-row items-center justify-center gap-5 pt-7">
