...
function Clients() {
    ...
    return (
        <>
            ...
            <div className="container m-12 mx-auto p-3" style={{ background: '#F8F8F8' }}>
                <div>
                    <h1 className="font-bold text-center m-12">TRUSTED BY 20,000 COMPANIES</h1>
                </div>
                <div className="slider-container m-12">
                    <Slider {...settings}>
                        ...
                        <div>
                            <svg width="105" height="24" viewBox="0 0 93 18" fill="currentColor" xmlns="http://www.w3.org/2000/svg" aria-label="Meta">
